...
public class PageModel {
    ...
    public void description() {
        ...
        String description = "共有数据数:" + this.getTotalRows() + "共有页数: " + this.getTotalPages()
                             + "当前页数为:" + this.getPage() + " 是否有前一页: " + this.isHasPreviousPage()
                             + " 是否有下一页:" + this.isHasNextPage() + " 开始行数:"
                             + this.getPageStartRow() + " 终止行数:" + this.getPageEndRow();
    ...
    public static void main(String[] args) {
        ...
        list.add("l");
        list.add("m");
        PageModel pm = new PageModel(list, 6);//每页显示条数

        List<Object> sublist = pm.getObjects(2);//显示第几页
