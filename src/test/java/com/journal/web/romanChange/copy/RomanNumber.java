...
public class RomanNumber{
    private final static String rnums[]={"M","CM","D","CD","C","XC","L","XL","X","IX","V","IV","I"}; //儲存所有羅馬數字
    private final static int anums[]={1000,900,500,400,100,90,50,40,10,9,5,4,1}; //儲存羅馬數字表示的值
